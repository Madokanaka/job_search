...
//        jdbcTemplate.update(sql, contactInfoDto.getResume().getId(), contactInfoDto.getType().getId(), contactInfoDto.getValue());
//    }
//
...
//            contactInfo.getResume().setId(rs.getInt("resume_id"));
//            contactInfo.getType.setId(rs.getInt("type_id"));
...
//            resume.setApplicant(rs.getInt("applicant_id"));
