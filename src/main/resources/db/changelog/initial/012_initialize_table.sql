...
VALUES ('Иван', 'Петров', 30, 'ivan.petrov@example.com', '$2y$10$KjB.pDNQJ1clygZmg6a/eO1hVHgii9L9l6L4fmAFNY/C0NtLVZdrq', '+77001112233', NULL, 'applicant', true, (select id from roles where role = 'APPLICANT'));

INSERT INTO users (name, surname, age, email, password, phone_number, avatar, account_type, enabled, role_id)
VALUES ('Мария', 'Сидорова', 40, 'maria.sidorova@example.com', '$2y$10$KjB.pDNQJ1clygZmg6a/eO1hVHgii9L9l6L4fmAFNY/C0NtLVZdrq', '+77009998877', NULL, 'employer', true, select id from roles where role = 'EMPLOYER');

INSERT INTO users (name, surname, age, email, password, phone_number, avatar, account_type, enabled, role_id)
VALUES ('Админ', 'Админ', 40, 'admin@example.com', '$2y$10$KjB.pDNQJ1clygZmg6a/eO1hVHgii9L9l6L4fmAFNY/C0NtLVZdrq', '+77009998877', NULL, 'admin', true, select id from roles where role = 'ADMIN');
